...
public class Client2 {
	...
	public Client2(String tag) {
		this.tag = tag;
	}

	public void run() {
		cc = new ClientCommand("localhost", 5571);
	...
	{
		ByteString image=obj.pokeImageSerialize("test/poke/server/resources/2.png");
		cc.register(image,tag, 1002);
	}
	
	public void sendImage()
	{
		ByteString image=obj.pokeImageSerialize("test/poke/server/resources/2.png");
		cc.sendImage("Hello", image,1002);
	}
	
	public static void main(String[] args) {
		try {
			Client2 jab = new Client2("client2");
			jab.run();
			jab.register();
			//jab.sendImage();
